package com.saber.spring_boot_camel_test.helper;
...
public class JalaliCalendar extends Calendar {
    ...
    public static YearMonthDate gregorianToJalali(YearMonthDate gregorian) {
        ...
        return new YearMonthDate(jalaliYear, i, jalaliDay);
    }

    public static DateTime gregorianToJalali(DateTime gregorian) {
        gregorian.setYear(gregorian.getYear() - 1600);
        ...
        int jalaliDay = jalaliDayNo + 1;
        return new DateTime(jalaliYear, i, jalaliDay, gregorian.hour, gregorian.minute, gregorian.second);
    }
    ...
    public static YearMonthDate jalaliToGregorian(YearMonthDate jalali) {
        ...
        return new YearMonthDate(gregorianYear, i, gregorianDay);
    }

    public static DateTime jalaliToGregorian(DateTime jalali) {
        jalali.setYear(jalali.getYear() - 979);
        ...
        int gregorianDay = gregorianDayNo + 1;
        return new DateTime(gregorianYear, i, gregorianDay, jalali.getHour(), jalali.getMinute(), jalali.second);
    }
    ...
    protected void computeTime() {
        if (!this.isTimeSet && !isTimeSeted) {
            ...
            YearMonthDate yearMonthDate = jalaliToGregorian(new YearMonthDate(this.internalGet(1), this.internalGet(2), this.internalGet(5)));
    ...
    public void add(int field, int amount) {
        if (field == 2) {
            ...
            YearMonthDate yearMonthDate = jalaliToGregorian(new YearMonthDate(this.get(1), this.get(2), this.get(5)));
